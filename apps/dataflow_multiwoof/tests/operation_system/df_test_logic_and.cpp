...
TEST_CASE("logic: and: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_AND;
    ...
    SECTION("DF_BOOLEAN") {
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BOOLEAN, &result);
        REQUIRE(&result != NULL);
        REQUIRE(return_value == 0);
    }//
    SECTION("DF_BYTE") {
...
TEST_CASE("logic: and: two values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_AND;
    ...
    SECTION("DF_BYTE") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_BYTE};
        const DF_VALUE op2 = {.value = {.df_int = 0}, .type=DF_BYTE};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BYTE,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_SHORT") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_SHORT};
        const DF_VALUE op2 = {.value = {.df_int = 0}, .type=DF_SHORT};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_SHORT,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_INTEGER") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_INTEGER};
        const DF_VALUE op2 = {.value = {.df_int = 0}, .type=DF_INTEGER};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_INTEGER,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_LONG") {
        const DF_VALUE op1 = {.value = {.df_long = 1}, .type=DF_LONG};
        const DF_VALUE op2 = {.value = {.df_long = 0}, .type=DF_LONG};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_LONG,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_BYTE") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_UNSIGNED_BYTE,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_SHORT") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count,
                                                    DF_UNSIGNED_SHORT, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_INTEGER") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count,
                                                    DF_UNSIGNED_INTEGER, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_LONG") {
        const DF_VALUE op1 = {.value = {.df_unsigned_long = 1}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op2 = {.value = {.df_unsigned_long = 0}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_UNSIGNED_LONG,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_DOUBLE") {
        const DF_VALUE op1 = {.value = {.df_double = 1}, .type=DF_DOUBLE};
        const DF_VALUE op2 = {.value = {.df_double = 0}, .type=DF_DOUBLE};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_DOUBLE,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_DATETIME") {
        const DF_VALUE op1 = {.value = {.df_long = 1}, .type=DF_DATETIME};
        const DF_VALUE op2 = {.value = {.df_long = 0}, .type=DF_DATETIME};
        const DF_VALUE op_list[] = {op1, op2};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_DATETIME,
                                                    &result);
        REQUIRE(&result != NULL);
...
TEST_CASE("logic: and: five values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_AND;
    ...
    SECTION("DF_BOOLEAN") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_BOOLEAN};
        const DF_VALUE op2 = {.value = {.df_int = 1}, .type=DF_BOOLEAN};
        const DF_VALUE op3 = {.value = {.df_int = 0}, .type=DF_BOOLEAN};
        const DF_VALUE op4 = {.value = {.df_int = 1}, .type=DF_BOOLEAN};
        const DF_VALUE op5 = {.value = {.df_int = 1}, .type=DF_BOOLEAN};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BOOLEAN,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_BYTE") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_BYTE};
        const DF_VALUE op2 = {.value = {.df_int = 1}, .type=DF_BYTE};
        const DF_VALUE op3 = {.value = {.df_int = 0}, .type=DF_BYTE};
        const DF_VALUE op4 = {.value = {.df_int = 1}, .type=DF_BYTE};
        const DF_VALUE op5 = {.value = {.df_int = 1}, .type=DF_BYTE};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BYTE,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_SHORT") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_SHORT};
        const DF_VALUE op2 = {.value = {.df_int = 1}, .type=DF_SHORT};
        const DF_VALUE op3 = {.value = {.df_int = 0}, .type=DF_SHORT};
        const DF_VALUE op4 = {.value = {.df_int = 1}, .type=DF_SHORT};
        const DF_VALUE op5 = {.value = {.df_int = 1}, .type=DF_SHORT};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_SHORT,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_INTEGER") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_INTEGER};
        const DF_VALUE op2 = {.value = {.df_int = 1}, .type=DF_INTEGER};
        const DF_VALUE op3 = {.value = {.df_int = 0}, .type=DF_INTEGER};
        const DF_VALUE op4 = {.value = {.df_int = 1}, .type=DF_INTEGER};
        const DF_VALUE op5 = {.value = {.df_int = 1}, .type=DF_INTEGER};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_INTEGER,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_LONG") {
        const DF_VALUE op1 = {.value = {.df_long = 1}, .type=DF_LONG};
        const DF_VALUE op2 = {.value = {.df_long = 1}, .type=DF_LONG};
        const DF_VALUE op3 = {.value = {.df_long = 0}, .type=DF_LONG};
        const DF_VALUE op4 = {.value = {.df_long = 1}, .type=DF_LONG};
        const DF_VALUE op5 = {.value = {.df_long = 1}, .type=DF_LONG};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_LONG,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_BYTE") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op3 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op4 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op5 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_UNSIGNED_BYTE,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_SHORT") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op3 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op4 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op5 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count,
                                                    DF_UNSIGNED_SHORT, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_INTEGER") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op3 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op4 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op5 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count,
                                                    DF_UNSIGNED_INTEGER, &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_UNSIGNED_LONG") {
        const DF_VALUE op1 = {.value = {.df_unsigned_long = 1}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op2 = {.value = {.df_unsigned_long = 1}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op3 = {.value = {.df_unsigned_long = 0}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op4 = {.value = {.df_unsigned_long = 1}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op5 = {.value = {.df_unsigned_long = 1}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_UNSIGNED_LONG,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_DOUBLE") {
        const DF_VALUE op1 = {.value = {.df_double = 1}, .type=DF_DOUBLE};
        const DF_VALUE op2 = {.value = {.df_double = 1}, .type=DF_DOUBLE};
        const DF_VALUE op3 = {.value = {.df_double = 0}, .type=DF_DOUBLE};
        const DF_VALUE op4 = {.value = {.df_double = 1}, .type=DF_DOUBLE};
        const DF_VALUE op5 = {.value = {.df_double = 1}, .type=DF_DOUBLE};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_DOUBLE,
                                                    &result);
        REQUIRE(&result != NULL);
    ...
    SECTION("DF_DATETIME") {
        const DF_VALUE op1 = {.value = {.df_long = 1}, .type=DF_DATETIME};
        const DF_VALUE op2 = {.value = {.df_long = 1}, .type=DF_DATETIME};
        const DF_VALUE op3 = {.value = {.df_long = 0}, .type=DF_DATETIME};
        const DF_VALUE op4 = {.value = {.df_long = 1}, .type=DF_DATETIME};
        const DF_VALUE op5 = {.value = {.df_long = 1}, .type=DF_DATETIME};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_DATETIME,
                                                    &result);
        REQUIRE(&result != NULL);
...
TEST_CASE("logic: and: five different value types") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_AND;
    const int operand_count = 5;
    DF_VALUE result;
    int return_value;
    ...
    SECTION("DIFFERENT->1") {
        const DF_VALUE op1 = {.value = {.df_int = 1}, .type=DF_BYTE};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 1}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op3 = {.value = {.df_int = 1}, .type=DF_INTEGER};
        const DF_VALUE op4 = {.value = {.df_long = 1}, .type=DF_LONG};
        const DF_VALUE op5 = {.value = {.df_double = 1}, .type=DF_DOUBLE};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BOOLEAN,
