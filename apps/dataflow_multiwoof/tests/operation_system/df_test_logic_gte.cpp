...
TEST_CASE("logic: gte: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN_EQUALS;
...
TEST_CASE("logic: gte: two values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN_EQUALS;
...
TEST_CASE("logic: gte: five values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN_EQUALS;
    ...
    SECTION("DF_BOOLEAN") {
        const DF_VALUE op1 = {.value = {.df_int = 5}, .type=DF_BOOLEAN};
        const DF_VALUE op2 = {.value = {.df_int = 3}, .type=DF_BOOLEAN};
        const DF_VALUE op3 = {.value = {.df_int = 3}, .type=DF_BOOLEAN};
        const DF_VALUE op4 = {.value = {.df_int = 2}, .type=DF_BOOLEAN};
    ...
    SECTION("DF_BYTE") {
        const DF_VALUE op1 = {.value = {.df_int = 5}, .type=DF_BYTE};
        const DF_VALUE op2 = {.value = {.df_int = 3}, .type=DF_BYTE};
    ...
    SECTION("DF_SHORT") {
        const DF_VALUE op1 = {.value = {.df_int = 5}, .type=DF_SHORT};
        const DF_VALUE op2 = {.value = {.df_int = 3}, .type=DF_SHORT};
    ...
    SECTION("DF_INTEGER") {
        const DF_VALUE op1 = {.value = {.df_int = 5}, .type=DF_INTEGER};
        const DF_VALUE op2 = {.value = {.df_int = 3}, .type=DF_INTEGER};
    ...
    SECTION("DF_LONG") {
        const DF_VALUE op1 = {.value = {.df_long = 5}, .type=DF_LONG};
        const DF_VALUE op2 = {.value = {.df_long = 3}, .type=DF_LONG};
    ...
    SECTION("DF_UNSIGNED_BYTE") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 5}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 3}, .type=DF_UNSIGNED_BYTE};
    ...
    SECTION("DF_UNSIGNED_SHORT") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 5}, .type=DF_UNSIGNED_SHORT};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 3}, .type=DF_UNSIGNED_SHORT};
    ...
    SECTION("DF_UNSIGNED_INTEGER") {
        const DF_VALUE op1 = {.value = {.df_unsigned_int = 5}, .type=DF_UNSIGNED_INTEGER};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 3}, .type=DF_UNSIGNED_INTEGER};
    ...
    SECTION("DF_UNSIGNED_LONG") {
        const DF_VALUE op1 = {.value = {.df_unsigned_long = 5}, .type=DF_UNSIGNED_LONG};
        const DF_VALUE op2 = {.value = {.df_unsigned_long = 3}, .type=DF_UNSIGNED_LONG};
    ...
    SECTION("DF_DOUBLE") {
        const DF_VALUE op1 = {.value = {.df_double = 5}, .type=DF_DOUBLE};
        const DF_VALUE op2 = {.value = {.df_double = 3}, .type=DF_DOUBLE};
    ...
    SECTION("DF_DATETIME") {
        const DF_VALUE op1 = {.value = {.df_long = 5}, .type=DF_DATETIME};
        const DF_VALUE op2 = {.value = {.df_long = 3}, .type=DF_DATETIME};
...
TEST_CASE("logic: gte: five different value types") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN_EQUALS;
    const int operand_count = 5;
    DF_VALUE result;
    int return_value;
    SECTION("DIFFERENT->0") {
        const DF_VALUE op1 = {.value = {.df_int = 3}, .type=DF_BYTE};
