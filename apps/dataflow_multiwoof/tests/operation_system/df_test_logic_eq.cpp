...
TEST_CASE("logic: eq: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_EQUALS;
...
TEST_CASE("logic: eq: five values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_EQUALS;
    ...
    SECTION("DF_BOOLEAN") {
        const DF_VALUE op1 = {.value = {.df_int = 2}, .type=DF_BOOLEAN};
        const DF_VALUE op2 = {.value = {.df_int = 2}, .type=DF_BOOLEAN};
        const DF_VALUE op3 = {.value = {.df_int = 2}, .type=DF_BOOLEAN};
        const DF_VALUE op4 = {.value = {.df_int = 2}, .type=DF_BOOLEAN};
        const DF_VALUE op5 = {.value = {.df_int = 2}, .type=DF_BOOLEAN};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BOOLEAN,
                                                    &result);
        REQUIRE(&result != NULL);
...
TEST_CASE("logic: eq: five different value types") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_EQUALS;
    const int operand_count = 5;
    DF_VALUE result;
    int return_value;
