...
TEST_CASE("logic: or: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_OR;
...
TEST_CASE("logic: or: five different value types") {
    ...
    int return_value;
    SECTION("DIFFERENT->0") {
        const DF_VALUE op1 = {.value = {.df_int = 0}, .type=DF_BYTE};
        const DF_VALUE op2 = {.value = {.df_unsigned_int = 0}, .type=DF_UNSIGNED_BYTE};
        const DF_VALUE op3 = {.value = {.df_int = 0}, .type=DF_INTEGER};
        const DF_VALUE op4 = {.value = {.df_long = 0}, .type=DF_LONG};
        const DF_VALUE op5 = {.value = {.df_double = 0}, .type=DF_DOUBLE};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BOOLEAN,
                                                    &result);
        REQUIRE(&result != NULL);
