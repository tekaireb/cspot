...
TEST_CASE("logic: gt: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN;
...
TEST_CASE("logic: gt: five values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN;
    ...
    SECTION("DF_BOOLEAN") {
        ...
        const DF_VALUE op2 = {.value = {.df_int = 4}, .type=DF_BOOLEAN};
...
TEST_CASE("logic: gt: five different value types") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_GREATER_THAN;
    const int operand_count = 5;
    DF_VALUE result;
    int return_value;
