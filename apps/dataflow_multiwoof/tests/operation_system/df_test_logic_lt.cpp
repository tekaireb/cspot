...
TEST_CASE("logic: lt: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN;
...
TEST_CASE("logic: lt: five values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN;
...
TEST_CASE("logic: lt: five different value types") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN;
    const int operand_count = 5;
    DF_VALUE result;
    int return_value;
