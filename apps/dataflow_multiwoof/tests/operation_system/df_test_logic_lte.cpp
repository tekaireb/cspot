...
TEST_CASE("logic: lte: no value") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN_EQUALS;
...
TEST_CASE("logic: lte: two values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN_EQUALS;
...
TEST_CASE("logic: lte: five values") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN_EQUALS;
    ...
    SECTION("DF_BOOLEAN") {
        ...
        const DF_VALUE op4 = {.value = {.df_int = 3}, .type=DF_BOOLEAN};
    ...
    SECTION("DF_BYTE") {
        ...
        const DF_VALUE op4 = {.value = {.df_int = 3}, .type=DF_BYTE};
    ...
    SECTION("DF_SHORT") {
        ...
        const DF_VALUE op4 = {.value = {.df_int = 3}, .type=DF_SHORT};
    ...
    SECTION("DF_INTEGER") {
        ...
        const DF_VALUE op4 = {.value = {.df_int = 3}, .type=DF_INTEGER};
    ...
    SECTION("DF_LONG") {
        ...
        const DF_VALUE op4 = {.value = {.df_long = 3}, .type=DF_LONG};
    ...
    SECTION("DF_UNSIGNED_BYTE") {
        ...
        const DF_VALUE op4 = {.value = {.df_unsigned_int = 3}, .type=DF_UNSIGNED_BYTE};
    ...
    SECTION("DF_UNSIGNED_SHORT") {
        ...
        const DF_VALUE op4 = {.value = {.df_unsigned_int = 3}, .type=DF_UNSIGNED_SHORT};
    ...
    SECTION("DF_UNSIGNED_INTEGER") {
        ...
        const DF_VALUE op4 = {.value = {.df_unsigned_int = 3}, .type=DF_UNSIGNED_INTEGER};
    ...
    SECTION("DF_UNSIGNED_LONG") {
        ...
        const DF_VALUE op4 = {.value = {.df_unsigned_long = 3}, .type=DF_UNSIGNED_LONG};
    ...
    SECTION("DF_DOUBLE") {
        ...
        const DF_VALUE op4 = {.value = {.df_double = 3}, .type=DF_DOUBLE};
    ...
    SECTION("DF_DATETIME") {
        ...
        const DF_VALUE op4 = {.value = {.df_long = 3}, .type=DF_DATETIME};
...
TEST_CASE("logic: lte: five different value types") {
    const DF_LOGIC_OP logic_operation = DF_LOGIC_LESS_THAN_EQUALS;
    const int operand_count = 5;
    DF_VALUE result;
    int return_value;
    SECTION("DIFFERENT->0") {
        ...
        const DF_VALUE op5 = {.value = {.df_double = 3}, .type=DF_DOUBLE};
        const DF_VALUE op_list[] = {op1, op2, op3, op4, op5};
        return_value = df_logic_operation_with_type(logic_operation, op_list, operand_count, DF_BOOLEAN,
                                                    &result);
        REQUIRE(&result != NULL);
